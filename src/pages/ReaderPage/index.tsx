...
const ReaderPage: React.FC = () => {
  ...
  React.useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (e.key === 'ArrowRight') {
        const tapEvent = { clientX: isRtl ? globalThis.window?.innerWidth * 0.1 : globalThis.window?.innerWidth * 0.9 } as any; 
        handleMangaTap(tapEvent);
      } else if (e.key === 'ArrowLeft') {
        const tapEvent = { clientX: isRtl ? globalThis.window?.innerWidth * 0.9 : globalThis.window?.innerWidth * 0.1 } as any;
        handleMangaTap(tapEvent);
      }
    };
