        ...
        {activeTab === 'amigos' && (
          <div className="tab-container animate-fade-in social-hub-container">
            ...
            <button 
              ...
              aria-label="Ir a la Taverna Global (Chat Mundial)"
            >
              ...
              <IonList className="social-list glass-list">
                {friends.map(friend => (
                  <IonItem key={friend.id} className="social-item">
                    <IonAvatar slot="start" className="clickable" style={{ position: 'relative' }}>
                      <button 
                    ...
                    <IonLabel className="clickable">
                      <button 
                        onClick={() => router.push(`/chat/${friend.id}`)} 
                        style={{ background: 'transparent', border: 'none', padding: 0, textAlign: 'left', color: 'inherit', fontWeight: 'inherit', fontSize: 'inherit' }}
                      >
