...
import { personCircleOutline, logOutOutline, timeOutline, trophyOutline, colorPaletteOutline, shieldCheckmarkOutline, diamondOutline, eyeOutline, playOutline, peopleOutline, copyOutline, pencilOutline, chatbubbles, chevronBackOutline, languageOutline } from 'ionicons/icons';
                        ...
                        .map(([mangaId, progress]) => {
                          ...
                          return (
                            <div 
                              ...
                              style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '14px', margin: 0, background: 'rgba(255,255,255,0.05)', borderRadius: '15px' }} 
                            >
                              <button 
                                className="history-item-main-area"
                                style={{ display: 'flex', alignItems: 'center', gap: '14px', flex: 1, textAlign: 'left', border: 'none', background: 'transparent', padding: 0, cursor: 'pointer', color: 'inherit' }}
